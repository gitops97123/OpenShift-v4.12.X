...
Let's push the operators to the quay mirror registry. 
    ...
    [root@bastion ocp-operators]# oc-mirror --from=/ocpregistry/ocp-operators/iaf-egov docker://bastion.lab.prodevans.com:8443
    Checking push permissions for bastion.lab.prodevans.com:8443
    Publishing image set from archive "/ocpregistry/ocp-operators/iaf-egov" to registry "bastion.lab.prodevans.com:8443"
    ...
    info: Mirroring completed in 2.75s (34.94MB/s)
    Wrote release signatures to oc-mirror-workspace/results-1697119734
    Rendering catalog image "bastion.lab.prodevans.com:8443/redhat/redhat-operator-index:v4.12" with file-based catalog
...
Download certified operator local Directory. 
